...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title>RHB Chatroom</title> <!-- title of page/chatroom -->
	...
	$get_message = "select * from messages where message_loc = 'RHB'"; // select all messages from appropriate chatroom using location field 
	...
	<?php } ?> <!-- end php tag -->
			...
			<div id="RHBChatroom"><img src="IMG/chatroom/RHBChatroom.png"></div>
			...
			<div id="Send"></div>
			<form action="RHB.php" method="post" enctype="multipart/form-data">
			<textarea id="textarea" name="msg_con" required>Enter message here...</textarea>
			<input type="submit" name="RHB" value=""/>
		</form>
		</div>
 </body>
 </html>
...
<?php
     ...
     if(isset($_POST['RHB'])){ // the user has submitted the chat to chatroom via the form do the following
