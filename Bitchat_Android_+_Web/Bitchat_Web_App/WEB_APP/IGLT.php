...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title>IGLT Chatroom</title> <!-- title of page/chatroom -->
	...
	$get_message = "select * from messages where message_loc = 'IGLT'"; // select all messages from appropriate chatroom using location field 
	...
	<?php } ?> <!-- end php tag -->
			...
			<div id="RHBChatroom"><img src="IMG/chatroom/IGLTChatroom.png"></div>
			...
			<div id="logo"><img src="IMG/chatroom/0logo.png"></div>
			<div id="username">  <?php echo $login_session; ?></div>
			<div id="Send"></div>
			<form action="IGLT.php" method="post" enctype="multipart/form-data">
			<textarea id="textarea" name="msg_con" required>Enter message here...</textarea>
			<input type="submit" name="IGLT" value=""/>
		</form>
		</div>
 </body>
 </html>
...
<?php
     ...
     if(isset($_POST['IGLT'])){ // the user has submitted the chat to chatroom via the form do the following
