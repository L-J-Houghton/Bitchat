...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title>DOC Chatroom</title> <!-- title of page/chatroom -->
	...
	$get_message = "select * from messages where message_loc = 'DOC'"; // select all messages from appropriate chatroom using location field 
	...
	<?php } ?> <!-- end php tag -->
			...
			<input type="submit" name="DOC" value=""/>
		</form>
		</div>
 </body>
 </html>
...
<?php
     ...
     if(isset($_POST['DOC'])){ // the user has submitted the chat to chatroom via the form do the following
